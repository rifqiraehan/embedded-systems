...
void StartYellowLED(void const * argument);
...
int main(void)
{
  ...
  /* definition and creation of YellowLED */
  osThreadDef(YellowLED, StartYellowLED, osPriorityNormal, 0, 128);
  YellowLEDHandle = osThreadCreate(osThread(YellowLED), NULL);
...
/* USER CODE BEGIN Header_StartYellowLED */
/**
* @brief Function implementing the YellowLED thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartYellowLED */
void StartYellowLED(void const * argument)
{
  /* USER CODE BEGIN StartYellowLED */
  /* Infinite loop */
  for(;;)
  {
	yellowState ^= 1;
